...
typedef struct mz_zip_file_s
{
    ...
    const char     *_filename;          /* filename utf8 null-terminated string */
    const uint8_t  *_extrafield;        /* extrafield data */
    const char     *_comment;           /* comment utf8 null-terminated string */
    const char     *_linkname;          /* sym-link filename utf8 null-terminated string */
